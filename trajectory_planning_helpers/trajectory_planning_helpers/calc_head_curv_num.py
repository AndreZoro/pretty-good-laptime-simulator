...
def calc_head_curv_num(path: np.ndarray,
    ...
    if is_closed:
        ...
        psi = normalize_psi.normalize_psi(psi)
        ...
        if calc_curv:
            ...
            for i in range(no_points):
                delta_psi[i] = normalize_psi.normalize_psi(psi_temp[i + steps_tot_curv] - psi_temp[i])
    ...
    # ------------------------------------------------------------------------------------------------------------------
        ...
        if calc_curv:
            ...
            # normalize delta_psi
            delta_psi = normalize_psi.normalize_psi(delta_psi)
